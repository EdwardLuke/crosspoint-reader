...
inline const std::vector<SettingInfo>& getSettingsList() {
  static const std::vector<SettingInfo> list = {
      ...
      SettingInfo::Enum(StrId::STR_SHOW_BATTERY_STATUS, &CrossPointSettings::showBatteryStatus, {StrId::STR_SHOW_BATTERY_STATUS_ALWAYS, StrId::STR_SHOW_BATTERY_STATUS_LOW}, "showBatteryStatus", StrId::STR_CAT_DISPLAY),
      SettingInfo::Enum(
      ...
      SettingInfo::Enum(StrId::STR_FONT_FAMILY, &CrossPointSettings::fontFamily,
                        {StrId::STR_BOOKERLY, StrId::STR_NOTO_SANS, StrId::STR_OPEN_DYSLEXIC, StrId::STR_ATKINSON_HYPERLEGIBLE_NEXT}, "fontFamily",
      ...
      SettingInfo::Enum(StrId::STR_EXTRA_SPACING, &CrossPointSettings::extraParagraphSpacing, {StrId::STR_PARA_STYLE_INDENT, StrId::STR_PARA_STYLE_EXTRA_SPACING}, "extraParagraphSpacing",
                          StrId::STR_CAT_READER),
