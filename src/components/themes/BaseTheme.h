...
class BaseTheme {
 public:
  ...
  virtual void drawBatteryLeft(const GfxRenderer& renderer, Rect rect,
                               bool showPercentage = true, bool hideOnHighPercentage = true) const;  // Left aligned (reader mode)
  virtual void drawBatteryRight(const GfxRenderer& renderer, Rect rect,
                                bool showPercentage = true, bool hideOnHighPercentage = true) const;  // Right aligned (UI headers)
