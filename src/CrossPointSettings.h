...
class CrossPointSettings {
 ...
 public:
  ...
  // Font family options
  enum FONT_FAMILY { BOOKERLY = 0, NOTOSANS = 1, OPENDYSLEXIC = 2, ATKINSONHYPERLEGIBLENEXT = 3, FONT_FAMILY_COUNT };
  // Font size options
  ...
  // How book paragraphs are indicated in EPUB reader
  enum PARAGRAPH_STYLE { EXTRA_SPACING = 0, INDENT = 1 };
  ...
  uint8_t extraParagraphSpacing = EXTRA_SPACING;
